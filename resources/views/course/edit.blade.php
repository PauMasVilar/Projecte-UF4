...
@section('title', 'Actualitzar curs')

@section('content')
    <div class="h-full flex items-center justify-center">
        <div class="bg-white p-8 rounded shadow-md w-11/12 sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-4/12">
            <h2 class="text-2xl font-semibold mb-6">Actualitzar curs</h2>
            <form action="{{ route("course.edit", ["course" => $course]) }}" method="post">
                @csrf
                <div class="flex flex-wrap -mx-3 mb-7">
                    <div class="w-full md:w-4/6 px-3 mb-6 md:mb-0">
                        ...
                        <input type="text" id="name" name="name" placeholder="..." value="{{ $course->name }}" class="mt-1 p-2 w-full border rounded-md">
                    ...
                    <div class="w-full md:w-2/6 px-3">
                        ...
                        <input type="text" id="duration" name="duration" placeholder="..." value="{{ $course->duration }}" class="mt-1 p-2 w-full border rounded-md">
                ...
                <div class="flex flex-wrap -mx-3 mb-7">
                    <div class="w-full px-3">
                        ...
                        <textarea id="description" name="description" placeholder="..." class="mt-1 p-2 w-full border rounded-md min-h-[150px]">{{ $course->description }}</textarea>
                ...
                <div class="flex flex-wrap -mx-3">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input type="date" id="start_date" name="start_date" value="{{ $course->start_date }}" class="mt-1 p-2 w-full border rounded-md">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input type="date" id="end_date" name="end_date" value="{{ $course->end_date }}" class="mt-1 p-2 w-full border rounded-md">
                ...
                <div class="flex justify-between items-center">
                    {{-- <a href="{{ route("course.back") }}" class="bg-red-600 text-white p-2 rounded-md hover:bg-red-700">Sortir</a> --}}
