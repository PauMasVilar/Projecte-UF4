...
@section('title', 'Afegir contingut')

@section('content')
    <div class="h-full flex items-center justify-center">
        <div class="bg-white p-8 rounded shadow-md w-11/12 sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-4/12">
            <h2 class="text-2xl font-semibold mb-6">Afegir contingut</h2>
            <form action="{{ route("moduleContent.create", ["module" => $module]) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex flex-wrap -mx-3 mb-7">
                    <div class="w-full px-3">
                        ...
                        <textarea id="content" name="content" placeholder="..." class="mt-1 p-2 w-full border rounded-md min-h-[250px]">{{ old("content") }}</textarea>
