...
@section('title', 'Nova tasca')

@section('content')
    <div class="h-full flex items-center justify-center">
        <div class="bg-white p-8 rounded shadow-md w-11/12 sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-4/12">
            <h2 class="text-2xl font-semibold mb-6">Nova tasca</h2>
            <form action="{{ route("assigment.create", ["moduleContent" => $moduleContent]) }}" method="post">
                @csrf
                <div class="flex flex-wrap -mx-3 mb-7">
                    <div class="w-full px-3 md:mb-0">
                        ...
                        <input type="text" id="title" name="title" placeholder="..." value="{{ old("title") }}" class="mt-1 p-2 w-full border rounded-md">
                ...
                <div class="flex flex-wrap -mx-3 mb-7">
                    <div class="w-full px-3 md:mb-0">
                        ...
                        <textarea id="description" name="description" placeholder="..." class="mt-1 p-2 w-full border rounded-md min-h-[250px]">{{ old("description") }}</textarea>
                ...
                <div class="flex flex-wrap -mx-3">
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <input type="date" id="due_date" name="due_date" value="{{ old("due_date") }}" class="mt-1 p-2 w-full border rounded-md">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button type="submit" class="bg-blue-600 text-white p-2 rounded-md hover:bg-blue-700 transition duration-300 ease-in-out">Afegir</button>
                </div>
            </form>
        </div>
    </div>
